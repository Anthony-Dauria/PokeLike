...
export class GameState {
  ...
  toJSON(): SaveData {
    return {
      ...
      repel: this.repel, steps: this.steps, uid: nextUid(), muted: this.muted, quality: this.quality, style: this.style, creatures: this.creatures,
    };
  }
  ...
  load(d: SaveData) {
    ...
    this.creatures = d.creatures === '3d' ? '3d' : 'sprites';
